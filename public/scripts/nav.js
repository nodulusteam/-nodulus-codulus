        ...
        controller: function ($scope,   $resource, $mdDialog, $mdBottomSheet,$Language) {
            ...
            $scope.menu = {
                ...
                showTreeBottomSheet: function ($event, node) {
                    ...
                    $mdBottomSheet.show({
                        templateUrl: '@nodulus/codulus/TreeMenu.html',
            ...
            $scope.subTreeResource = $resource('@nodulus/codulus/folders', { ParentId: "@parentid" });
            ...
            {
                if(!node.isDirectory)
                        $IDE.ShowLobby(node, "@nodulus/codulus/codulus.html");
            }
        },
        templateUrl: "@nodulus/codulus/nav.html",
